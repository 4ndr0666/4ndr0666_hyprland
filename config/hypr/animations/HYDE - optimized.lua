-- File: animations/HYDE - optimized.lua
...
hl.animation({ leaf = "windowsMove", enabled = true, speed = 3.0, curve = "wind", style = "slide" })
...
hl.animation({ leaf = "workspaces", enabled = true, speed = 4.0, curve = "menu_decel", style = "slide" })
