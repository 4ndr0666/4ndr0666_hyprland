-- File: animations/HYDE - default.lua
...
hl.animation({ leaf = "borderangle", enabled = true, speed = 30, curve = "liner", style = "once" })
hl.animation({ leaf = "fade", enabled = true, speed = 10, curve = "default" })
hl.animation({ leaf = "workspaces", enabled = true, speed = 5, curve = "wind" })
hl.animation({ leaf = "specialWorkspace", enabled = true, speed = 5, curve = "wind", style = "slidevert" })
