-- File: configs/WindowRules-config-v3.lua
...
hl.window_rule({ match = { class = "^(zen)$" }, tag = "+browser" })
...
hl.window_rule({ match = { title = "^(4ndr0666 Quick Cheat Sheet)$" }, tag = "+4ndr0666_Cheat" })
hl.window_rule({ match = { title = "^(4ndr0666 Hyprland Settings)$" }, tag = "+4ndr0666_Settings" })
hl.window_rule({ match = { class = "^(nwg-displays|nwg-look)$" }, tag = "+4ndr0666_Settings" })
...
-- POSITION
hl.window_rule({ match = { tag = "4ndr0666_Cheat" }, center = true })
...
hl.window_rule({ match = { tag = "4ndr0666_Settings" }, center = true })
...
hl.window_rule({ match = { fullscreen = true }, idleinhibit = "fullscreen" })
...
hl.window_rule({ match = { tag = "4ndr0666_Settings" }, float = true })
...
hl.window_rule({ match = { initialTitle = "(Open Files)" }, float = true, size = "(monitor_w*0.7) (monitor_h*0.6)" })
...
hl.window_rule({ match = { class = "^(yad)$", title = "^(YAD)$" }, float = true, center = true, size = "(monitor_w*0.2) (monitor_h*0.2)" })
...
-- SIZE
hl.window_rule({ match = { tag = "4ndr0666_Cheat" }, size = "(monitor_w*0.65) (monitor_h*0.9)" })
...
hl.window_rule({ match = { class = "(org.gnome.Calculator|qalculate-gtk)" }, center = true, size = "(monitor_w*0.25) (monitor_h*0.3)" })

-- BLUR & FULLSCREEN
hl.window_rule({ match = { tag = "games" }, noblur = true, fullscreen = 0 })
