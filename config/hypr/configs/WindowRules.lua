...
-- System settings & cheat sheet tags
hl.window_rule({ match = { title = "^(Quick Cheat Sheet)$" }, tag = "+Cheat_Sheet" })
hl.window_rule({ match = { title = "^(Hyprland Settings)$" }, tag = "+Sys_Settings" })
hl.window_rule({ match = { class = "^(nwg-displays|nwg-look)$" }, tag = "+Sys_Settings" })
...
-- POSITION
hl.window_rule({ match = { tag = "Cheat_Sheet" }, center = true })
...
hl.window_rule({ match = { tag = "Sys_Settings" }, center = true })
...
-- FLOAT
hl.window_rule({ match = { tag = "Cheat_Sheet" }, float = true })
...
hl.window_rule({ match = { tag = "Sys_Settings" }, float = true, center = true })
...
-- SIZE
hl.window_rule({ match = { tag = "Cheat_Sheet" }, size = "(monitor_w*0.65) (monitor_h*0.9)" })
